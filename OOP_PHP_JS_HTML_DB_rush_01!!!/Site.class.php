...
class Site
{
  ...
  public static function newGame($num_players)
  {
    ...
    if (key_exists('gid', $_SESSION) && isset($_SESSION['gid']))
      throw new Exception("You are alredy in game1");
    ...
    if (!$res = DB::query(
      ...
      VALUES (NULL,
        ...
        . DB::esc($num_players) . "');"))
    {
      throw new Exception("DATABASE ERROE IN newGame");
    }
    if ($res == True)
    {
      if (!$res = DB::query(
  ...
  public static function viewAllGames()
  {
    ...
    {
      $res = $res . "<div class='game'> "
      ."<form action='ajax.php?action=join' method='post'>"
      ."p1: ". $crow['uid1']
      ." p2:".$crow['uid2']
      ." p3:".$crow['uid3']
      ." p4:".$crow['uid4']
      ." size:".$crow['user_count']."/".$crow['size']."  "
